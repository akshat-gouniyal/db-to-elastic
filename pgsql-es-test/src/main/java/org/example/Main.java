...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int esPort = 9200;
        String esIndex = "joinedtable";  // Your index name
        ...
        int maxRecords = 40929744; // Change this value as needed (e.g., 1000000 for one million)
        ...
        try (
            ...
            while (moreRecords && (maxRecords == -1 || totalFetched < maxRecords)) {
                ...
                String query = "SELECT * FROM product ORDER BY id ASC LIMIT " +
